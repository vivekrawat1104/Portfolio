...
//          <img className="w-[48px] bs-mx:w-[36px] xsm-mx:w-[28px] !p-1"  src={`../assets/icons/${skill}.png`} /> 
...
const SkillBadge = ({ skill }: { skill: string }) => {
    ...
    return (
        ...
        >
            {icon && <img className="w-[48px] bs-mx:w-[36px] xsm-mx:w-[28px] !p-1" src={icon} alt={`${skill} Icon`} />}
            <div className="text-textColor text-xl font-medium sm-mx:text-lg xs-mx:text-sm">{skill}</div>
        </div>
    );
};
