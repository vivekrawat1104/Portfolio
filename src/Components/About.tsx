    ...
    return (
        <>
            ...
            >
                ...
                {/* Removed the iframe here, will be inside ResumeViewer */}
                ...
                <div className="h-fit flex justify-center items-center rounded-full bs:mr-10 w-fit">
                    <NeonGradientCard className="w-[325px] h-[325px] lg-mx:w-64 lg-mx:h-64 xsm-mx:w-56 xsm-mx:h-56 items-center justify-center text-center">
                        {/* <img className="w-full h-full rounded-full" src="https://drive.google.com/thumbnail?id=1QeZyY6jsWYkHoUE2G2guOkZgdYI3q84U" alt="profile" /> */}
                        <img className="w-full h-full rounded-full" src={profileImage} alt="profile" />
                    </NeonGradientCard>
                </div>
            </div>

            {/* Resume Viewer - Shows only when opened */}
            {opened && <ResumeViewer opened={opened} close={close} />}
        </>
    );
};
